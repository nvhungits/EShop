...
namespace Sourcecode_Intellivue.Interfaces.StandardReports
{
    ...
    partial class AdviserInflowReport : CoreClass
    {
        ...
        protected void Page_Load(object sender, System.EventArgs e)
        {
            ...
            {
                string accessright = GlobalClass.GetAccessRight("R2");
                if (accessright == "F")
                {
            ...
            if (Request.Form["txtAction"] == "AdviserInflow")
            {
                SecondInitial();
            }
        ...
        private void loadReportViewer()
        {
            try
            {
                ...
                //Me.ReportViewer1.ServerReport.ReportPath = System.Configuration.ConfigurationManager.AppSettings("AdviserInflowReport")
