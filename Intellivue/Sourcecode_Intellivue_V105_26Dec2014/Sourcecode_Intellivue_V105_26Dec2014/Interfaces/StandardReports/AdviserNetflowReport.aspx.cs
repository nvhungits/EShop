...
namespace Sourcecode_Intellivue.Interfaces.StandardReports
{
    ...
    public partial class AdviserNetflowReport : CoreClass
    {
        Microsoft.Reporting.WebForms.ReportParameter[] Param = new Microsoft.Reporting.WebForms.ReportParameter[13];
        string[] GroupBy = {
		("InvestmentOption"),
		("Product"),
		("Adviser"),
        ...
        protected void Page_Load(object sender, System.EventArgs e)
        {
            ...
            {
                string accessright = GlobalClass.GetAccessRight("R3");
                if (accessright == "F")
                {
            ...
            //If Request.Form("txtAction") = "AdviserNetflow" Then
            //    SecondInitial()
            //End If
            //Else
            //Response.Redirect("~/Default.aspx")
        ...
        private void loadReportViewer()
        {
            try
            {
                Param[0] = new Microsoft.Reporting.WebForms.ReportParameter("DateFrom", Request.Form["DateFrom"]);
                Param[1] = new Microsoft.Reporting.WebForms.ReportParameter("DateTo", Request.Form["DateTo"]);
                Param[2] = new Microsoft.Reporting.WebForms.ReportParameter("DealerGroup", Request.Form["DealerGroup"]);
                Param[3] = new Microsoft.Reporting.WebForms.ReportParameter("Adviser", Request.Form["Adviser"]);
                Param[4] = new Microsoft.Reporting.WebForms.ReportParameter("Product", Request.Form["Product"]);
                Param[5] = new Microsoft.Reporting.WebForms.ReportParameter("InvestmentOption", Request.Form["InvestmentOption"]);
                ...
                Param[10] = new Microsoft.Reporting.WebForms.ReportParameter("AdviserState", Request.Form["AdviserState"]);
                Param[11] = new Microsoft.Reporting.WebForms.ReportParameter("TopN", Request.Form["TopN"]);

                //*****Need to change UserID*******
                Param[12] = new Microsoft.Reporting.WebForms.ReportParameter("UserID", Session["username"].ToString().ToUpper());
                ...
                //Me.ReportViewer1.ServerReport.ReportPath = System.Configuration.ConfigurationManager.AppSettings("AdviserNetflowReport")
