<%@ Page Language="C#" MasterPageFile="~/MasterPage/Default.Master" AutoEventWireup="true" CodeBehind="CubeBrowse.aspx.cs" Inherits="Sourcecode_Intellivue.Interfaces.CubeBrowser.CubeBrowse" Title="Untitled Page" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="search_criteria_bar">
        <div class="search_criteria_leftcolumn">
            ...
            <div>
                <div>
                    <span >Cube Name </span > : <asp:TextBox ID="txtCubeName" runat="server"></asp:TextBox>
                </div>
                <div>
                    <asp:Button ID="btnSaveCubeTemplate" CssClass="new_button" runat="server" 
                        Text="Save" onclick="btnSaveCubeTemplate_Click" />
                </div>
                
                </div>
                <div>
                    <asp:Label ID="lblError" runat="server" Text="test" Visible="false"></asp:Label>
                </div>
            </div>
    ...
    <div class="page_heading">Cube Management</div>
        ...
        <tr>
            <td>
                 <dx:ASPxPivotGrid ID="ASPxPivotGrid1" runat="server"  
                     ...
                     Width="100%" onfieldareachanged="ASPxPivotGrid1_FieldAreaChanged">
