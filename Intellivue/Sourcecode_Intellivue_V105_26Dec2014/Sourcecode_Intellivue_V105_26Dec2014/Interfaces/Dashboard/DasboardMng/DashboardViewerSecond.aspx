<%@ Page Title="I N T E L L I V U E - View Dashboard" Language="C#" MasterPageFile="~/MasterPage/Default.Master" AutoEventWireup="true" CodeBehind="DashboardViewerSecond.aspx.cs" Inherits="Sourcecode_Intellivue.Interfaces.Dashboard.DasboardMng.DashboardViewerSecond" %>
...
<script type="text/javascript">
	...
	<asp:ScriptManager ID="ScriptManager1" runat="server" EnablePartialRendering="true"></asp:ScriptManager>
		...
		<table border="0" width="1048" id="table1" cellspacing="0" cellpadding="0" height="804px">
...
<table width="974px" border="0" cellpadding="0" cellspacing="0" height="100%">
          <tr>
          ...
          <tr>
            <td width="1004" height="28" background="Images/dashboard mng/bg3.gif">&nbsp;</td>
          </tr>
        </table>  
