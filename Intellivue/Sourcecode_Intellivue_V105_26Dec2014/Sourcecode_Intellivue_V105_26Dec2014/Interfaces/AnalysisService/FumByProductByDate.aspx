<%@ Page Title="I N T E L L I V U E - FUM By Product By Date" Language="C#" MasterPageFile="~/MasterPage/Default.Master" AutoEventWireup="true" CodeBehind="FumByProductByDate.aspx.cs" Inherits="Sourcecode_Intellivue.Interfaces.AnalysisService.FumByProductByDate" %>
...
function ViewReport_onclick()
{
    ...
    frame.src = "ReportPage.aspx?KeyName=Fum_ByProduct_ByDate&ParameterNames=Product~InvestmentOption~Year~Month&ParameterValues=" + Product + "~" + InvestmentOption + "~" + Year.value.replace(/&/,"%") + "~" + Month.value.replace(/&/,"%");
...
<input type="hidden" name="txtAction" id="txtAction" class="lbNormal" />
		...
		<table border="0" width="100%" id="table1"  cellspacing="0" cellpadding="0" >
            ...
            <table border="0" style="padding-right: 5px; padding-left: 5px; padding-bottom: 5px; width:100%;
                 padding-top: 5px; border-bottom: black 1px solid; background-color: #A3C4B4" id="table2">
                <tr>
                    ...
                    <td width="15%" valign="top" bgcolor="#A3C4B4" style="padding-right: 10px; padding-left: 10px; padding-bottom: 10px; border-left: black 1px solid;
						...
						<table border="0" width="100%" id="table10" height="734" cellspacing="0" cellpadding="0">
							<tr>
								<td valign="top" width="100%">
                                     <iframe id="ReportViewer1" Width="100%" height="800px" scrolling="auto" name="ReportViewer1" border="0" frameborder="0">
                                     </iframe>
     							</td>
							</tr>
